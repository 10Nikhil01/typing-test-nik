...
const AccountIcon = () => {
  ...
  if (user) console.log(`Hi ${user.displayName}`);
  const handleClose = () => {
    setOpen(false);
  };
  ...
  const handleOpen = () => {
    if (user) {
      console.log("Hi", user.displayName, user);
  ...
  return (
    <div>
      ...
      <Modal open={open} onClose={handleClose} sx={{display:"flex", justifyContent:"center", alignItems:"center"}} className={classes.modal}>
